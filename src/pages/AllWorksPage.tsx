    ...
    <div className="w-full min-h-screen bg-background pt-[100px] pb-16 relative">
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-8 relative z-10">
        ...
        <div className="flex flex-col items-center text-center space-y-4 mb-12">
          <div className="glass-pill">PORTFOLIO</div>
        ...
        <div 
          className={`flex w-full overflow-x-auto hide-scrollbar justify-start md:justify-center gap-3 mb-16 pb-2 transition-all duration-300 ease-in-out ${
            isScrolled 
              ...
              return (
                ...
                >
                  <div className="border-l-2 border-primary pl-4 py-1">
                    <h2 className="font-serif text-[28px] md:text-[34px] leading-tight text-white mb-2">
                      {sect.title}
                    </h2>
                    <p className="text-muted text-sm md:text-base font-sans max-w-2xl">
                      {sect.subtitle}
                    </p>
                  </div>

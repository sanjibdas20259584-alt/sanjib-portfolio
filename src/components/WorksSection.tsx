...
export const WorksSection = () => {
  ...
  return (
    <section id="my-works" className="w-full relative mt-[64px] pb-[64px]">
      <div className="max-w-7xl mx-auto px-6 md:px-8">
        <div className="flex flex-col items-center text-center space-y-6 mb-2">
          ...
          {/* Filter Pills */}
          <div 
            className="flex w-full overflow-x-auto hide-scrollbar justify-start md:justify-center gap-3"
            style={{
              position: 'sticky',
              top: 0,
              zIndex: 50,
      ...
      <div 
        ref={containerRef}
        className="w-full relative px-6 md:px-8"
      >
      ...
      {/* View More Button */}
      <div className="flex justify-center mt-16 relative z-30 w-full px-6 md:px-0">
        <Link 
          to="/works" 
          onClick={() => trackEvent({
          ...
          className="btn-primary px-8 py-4 text-base md:text-lg font-semibold tracking-wide shadow-lg w-full sm:w-auto text-center hover:brightness-110"
        >
          View More
        </Link>
      </div>

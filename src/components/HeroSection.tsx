    ...
    <section className="relative w-full transition-all duration-700 ease-in-out flex flex-col justify-start pt-[64px] sm:pt-[80px] pb-10 md:pb-[48px]">
      ...
      >
        ...
        <div className="flex items-center rounded-full border border-[rgba(164,132,215,0.5)] bg-[rgba(85,80,110,0.4)] backdrop-blur-[16px] p-1 pr-3 sm:p-1.5 sm:pr-4">
          <span className="bg-[#7B39FC] text-white text-[9px] sm:text-[10px] md:text-xs font-bold uppercase tracking-wider px-3 py-1 sm:px-4 sm:py-1.5 rounded-full mr-2 sm:mr-3">Available</span>
          <span className="text-[9px] sm:text-[10px] md:text-sm text-white font-medium pr-1">Open for Freelance Projects</span>
        </div>
        ...
        <div className="flex flex-col sm:flex-row gap-3 sm:gap-6 mt-3 sm:mt-4 justify-center w-full max-w-[480px] px-2 sm:px-0">
          <a href="#my-works" className="btn-hero-primary w-full rounded-2xl text-white font-medium py-3 sm:py-4 px-6 flex items-center justify-center text-sm sm:text-base md:text-lg text-center">
            View My Work
          </a>
        ...
        <div className="flex flex-wrap justify-center gap-2 mt-6 sm:mt-[2rem]">
          {[{l: "About Me", h: "#about-me"}, {l: "My Works", h: "#my-works"}, {l: "Pricing", h: "#pricing"}, {l: "Reach Out", h: "#reach-out"}].map(t => (
            <a key={t.l} href={t.h} className="glass-pill !font-sans !normal-case !tracking-normal !px-3 !py-1.5 sm:!px-4 sm:!py-2 md:!px-6 md:!py-3 text-xs sm:text-sm md:text-base hover:bg-[rgba(164,132,215,0.2)] transition-colors">
              {t.l}
            </a>
          ))}
        </div>
